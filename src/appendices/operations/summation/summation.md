...
**例**:
给定一个数列 $a_1, a_2, \dots, a_n$,其中$n$是非负整数, 可以将有限和 $a_1 + a_2 + \dots + a_n$ 写作:
$$
\sum_{i=1}^{n} a_i
$$
并且:
...
$$
\begin{aligned}
\sum_{i=1}^n \left[(i+1)^3 - i^3\right] &= (n+1)^3 - 1^3        \\
                                        &= n^3 + 3n^2 + 3n
\end{aligned}
$$
...
$$
\begin{aligned}
\sum_{i=1}^n (3i^2 + 3i + 1) &= 3\sum i^2 + 3\sum i + \sum 1        \\
                             &= 3S_2 + 3\cdot\frac{n(n+1)}{2} + n
\end{aligned}
$$
...
$$
\begin{aligned}
\sum_{i=1}^n \left[(i+1)^4 - i^4\right] &= (n+1)^4 - 1              \\
                                        &= n^4 + 4n^3 + 6n^2 + 4n
\end{aligned}
$$
...
$$
\begin{aligned}
4\sum i^3 + 6\sum i^2 + 4\sum i + \sum 1 &= 4S_3                            \\
